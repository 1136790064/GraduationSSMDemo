...
<div class="layui-layout layui-layout-admin">
    <div class="layui-header">
        ...
        <ul class="layui-nav layui-layout-left">
            ...
            <%--            <li class="layui-nav-item"><a href="">项目审核</a></li>--%>
        ...
        <ul class="layui-nav layui-layout-right">
            <li class="layui-nav-item">
                ...
                <dl class="layui-nav-child">
                    <dd><a href="../html/editTeacher.html">修改信息</a></dd>
                    <dd><a href="">安全设置</a></dd>
                </dl>
            </li>
        ...
        <div class="layui-side-scroll">
            ...
            <ul class="layui-nav layui-nav-tree" lay-filter="test">
                <li class="layui-nav-item layui-nav-itemed">
                    ...
                    <dl class="layui-nav-child">
                        <dd><a href="../html/project_list_teacher.html">审核项目</a></dd>
                        <dd><a href="../html/auditFindings.html">查看审核</a></dd>
<%--                        <dd><a href="../html/student_list.html">学生列表</a></dd>--%>
<%--                        <dd><a href="../html/adm_list.html">管理员列表</a></dd>--%>
